...
if(isset($_POST["nome"],$_POST["email"],$_POST["senha"],$_POST["confirmaSenha"])){
    ...
    elseif ($_POST["confirmaSenha"] !== $_POST["senha"]) {
        ...
        $senha = tratarForm($_POST["confirmaSenha"]);
    }
        ...
        <p class="description description-primary">or use your email for registration</p>
            <form class="form" action="#" method="post" novalidate>
                <label class="label-input" for="name">
                    ...
                    <input id="name" name="nome" type="text" placeholder="Nome" required>
                </label>

                <?php if(isset($erros["nome"])){?>
                    <div class="erro">
                        <h3><?php echo $erros["nome"];?></h3>
                ...
                <label class="label-input" for="confirm-password">
                    <i class="fa-solid fa-lock icon-modify" aria-hidden="true"></i>
                    <input id="confirm-password" name="confirmaSenha" type="password" placeholder="Confirma sua Senha" required>
                </label>

                    <?php if(isset($erros["confirmaSenha"])){?>
                    <div class="erro">
